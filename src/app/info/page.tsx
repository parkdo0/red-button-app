...
const STORE_NAME = "수원점";
const TABLE_NUMBER = 31;
const CHECK_IN_TIME = "오후 5시 2분";

/**
 * 이용 정보 - 실제 레드버튼 앱 기준
 * 매장/테이블, 이용 시간 카운트업, Wi-Fi, 이용 안내, 고객 의견
 */
export default function InfoPage() {
  const [elapsedMinutes, setElapsedMinutes] = useState(9);
        ...
        <div className="rb-card p-6 flex flex-col items-center text-center">
          ...
          <div className="mt-4 flex flex-col gap-1">
            <div>
              ...
              <p className="text-lg font-bold text-text-primary">redbutton</p>
            </div>
            <div className="mt-1">
              <span className="text-[11px] text-text-muted">PW</span>
              <p className="text-lg font-bold text-text-primary">red2563799</p>
            </div>
          </div>
        </div>
